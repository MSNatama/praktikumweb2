<?php
    ...
    function AddMember($nama_member, $nomor_member, $alamat, $tgl_mendaftar, $tgl_terakhir_bayar) {
        ...
        $result = $stmt->execute(array(':nama' => $nama_member, ':nomor_member' => $nomor_member, ':alamat' => $alamat, ':tgl_mendaftar' => $tgl_mendaftar, ':tgl_terakhir_bayar' => $tgl_terakhir_bayar));
        if (!empty($result)) {
    ...
    function UpdateMember($id_member, $nama_member, $nomor_member, $alamat, $tgldft, $tgl_terakhir_bayar) {
        $pdo_statement = koneksi()->prepare(
            "update member set nama_member='" . $nama_member . "', nomor_member='" . $nomor_member . "', alamat='" . $alamat . "', tgl_mendaftar='" . $tgldft . "', tgl_terakhir_bayar='" . $tgl_terakhir_bayar . "' where id_member=" . $id_member
        );
